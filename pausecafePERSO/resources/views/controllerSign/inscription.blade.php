...
@section('content')
    ...
    <div class="container">
        <div class="offset-lg-2 col-lg-8 offset-lg-2 offset-md-2 col-md-8 offset-md-2 offset-sm-2 col-sm-8 offset-sm-2">
            ...
            <form method="POST" id="font-inscription" action="{{route ('centresInterets')}}" class="well" role="form">
                {{ csrf_field() }}
                <fieldset>
                    <p class="form-group">
                        ...
                        <input type="text" name="pseudo" id="utilisateur" class="form-control"
                               ...
                               data-validation-help="Caractères autorisés : Seulement les caractères minuscules et numériques. ESPACE non autorisés">
                    </p>
                    <p class="form-group">
